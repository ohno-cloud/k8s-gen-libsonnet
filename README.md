...
The [`custom/`](https://github.com/ohno-cloud/k8s-gen-libsonnet/tree/master/libs/k8s/custom)
...
```jsonnet
(import "github.com/ohno-cloud/k8s-gen-libsonnet-libsonnet/1.21/main.libsonnet")
+ (import "github.com/ohno-cloud/k8s-gen-libsonnet-libsonnet/extensions/<name>.libsonnet")
```
